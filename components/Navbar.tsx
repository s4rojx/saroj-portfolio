...
const icons: Record<string, React.ReactNode> = {
  ...
  projects: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M7 8l-4 4 4 4M17 8l4 4-4 4M14 4l-4 16" /></svg>,
        ...
        <div className="flex items-center justify-between max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-16 py-5">
          <Link href="/">
            <div style={{
              ...
              justifyContent: "center", backgroundColor: "#0e0e0e",
            }}>
              <Image src="/logo.svg" alt="Logo" width={52} height={52}
                style={{ objectFit: "cover", minWidth: "52px", minHeight: "52px" }} />
            </div>
          </Link>
